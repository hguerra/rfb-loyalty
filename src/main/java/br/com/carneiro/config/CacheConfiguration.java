package br.com.carneiro.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(br.com.carneiro.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(br.com.carneiro.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
            cm.createCache(br.com.carneiro.domain.User.class.getName(), jcacheConfiguration);
            cm.createCache(br.com.carneiro.domain.Authority.class.getName(), jcacheConfiguration);
            cm.createCache(br.com.carneiro.domain.User.class.getName() + ".authorities", jcacheConfiguration);
